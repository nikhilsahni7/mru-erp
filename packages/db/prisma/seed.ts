...
import { Branch, Clg, CourseType, DayOfWeek, PrismaClient, Role } from '@prisma/client';
import bcrypt from 'bcryptjs';
...
async function main() {
  ...
  const teacherIds = {};
  for (const teacher of teachers) {
    const user = await prisma.user.findUnique({ where: { rollNo: teacher.initials } });
    if (user) {
  ...
  const createCourseWithComponents = async (courseCode, teacherInitials, components) => {
    ...
    if (!teacherId) {
      console.error(`Teacher not found. Please ensure at least one teacher exists`);
      return;
    }
    ...
    for (const comp of components) {
      ...
      if (comp.group === 'G1') {
        ...
        await createComponent(sectionCourse.id, comp, componentTeacherId, group1.id);
      } else if (comp.group === 'G2') {
        // Group 2 specific component
        await createComponent(sectionCourse.id, comp, componentTeacherId, group2.id);
      } else {
      ...
      for (const schedule of comp.schedules) {
        await prisma.classSchedule.create({
          data: {
            ...
            startTime: new Date(`2025-01-01T${schedule.startTime}:00`),
            endTime: new Date(`2025-01-01T${schedule.endTime}:00`),
  ...
  await createCourseWithComponents('PC', 'SS', [
    ...
    },
    {
      ...
      schedules: [
        { day: 'WEDNESDAY', startTime: '09:40', endTime: '10:30', room: 'K509' },
  ...
  await createCourseWithComponents('CG', 'DG', [
    {
      ...
      schedules: [
        ...
        { day: 'WEDNESDAY', startTime: '10:30', endTime: '11:20', room: 'K509' },
  ...
  await createCourseWithComponents('IPR', 'YA', [
    {
      ...
      schedules: [
        ...
        { day: 'WEDNESDAY', startTime: '08:50', endTime: '09:40', room: 'HF05' },
      ],
    },
  ]);
  ...
  for (const student of students) {
    ...
    const studentGroupId = ['2K22CSUN01043', '2K22CSUN01044', '2K22CSUN01046', '2K22CSUN01047',
         '2K22CSUN01048', '2K22CSUN01049', '2K22CSUN01050', '2K22CSUN01051',
         '2K22CSUN01052', '2K22CSUN01053', '2K22CSUN01054', '2K22CSUN01055',
         '2K22CSUN01056', '2K22CSUN01057', '2K22CSUN01058', '2K22CSUN01059',
         '2K22CSUN01060', '2K22CSUN01061', '2K22CSUN01062', '2K22CSUN01063',
         '2K22CSUN01064'].includes(student.rollNo) ? group1.id : group2.id;
