...
import { AlertCircle, Calendar, Clock, Loader2, Save, User } from "lucide-react";
...
export function EditAttendanceRecordForm({ recordId }: EditAttendanceRecordFormProps) {
            ...
            {recordData.session && (
              <div className="pt-4 border-t">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>
                    {recordData.session.date ? formatDate(recordData.session.date) : "N/A"}
                  </span>
                </div>
